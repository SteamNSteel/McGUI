...
public enum Proxies
{
    ...
    @SuppressWarnings("WeakerAccess")
    public static final String CLIENT_NETWORK_PROXY_CLASS = "com.example.examplemod.ClientNetworkProxy";

    @SuppressWarnings("WeakerAccess")
    public static final String COMMON_NETWORK_PROXY_CLASS = "com.example.examplemod.CommonNetworkProxy";
